...
def read_data(data_dir):
 ...
 #  这里的res indicates edge_att.data.numpy(), edge_index.data.numpy(),  att,  num_nodes
    res = [] 
...
def read_sigle_data(data_dir,filename,use_gdc =False):
    ...
    # data = Data(x=att_torch, edge_index=edge_index.long(), edge_attr=edge_att)
...
if __name__ == "__main__":
    data_dir = '/home/azureuser/projects/DMGPK/data/AD_pcp/cpac/filt_noglobal/raw'
    filename = '50346.h5'
